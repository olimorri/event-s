...
export default function EventDetails({ events, signUpDown, user }: EventDetailProps) {
  ...
  const event: Event | undefined = events.find((el: Event) => el._id === id); //Event: {}
                  ...
                  >
                    <Wrap align={'center'}>
                      <Image
                        borderRadius="md"
                        src={
                          'https://res.cloudinary.com/dujun1hoe/image/upload/v1615296945/event-s/icons/calendar-2_hmjf1m.png'
                        }
                        alt=""
                      />
                      <Text justify={'center'}>
                  ...
                  >
                    <Wrap align={'center'}>
                      <Image
                        borderRadius="md"
                        src={
                          'https://res.cloudinary.com/dujun1hoe/image/upload/v1615296946/event-s/icons/alarm-2_csdsdf.png'
                        }
                        alt=""
                      />
                  ...
                  >
                    <Wrap align={'center'}>
                      <Image
                        borderRadius="md"
                        src={
                          'https://res.cloudinary.com/dujun1hoe/image/upload/v1615297028/event-s/icons/announcement_pr7pea.png'
                        }
                        alt=""
                      />
                  ...
                  >
                    <Wrap align={'center'}>
                      <Image
                        borderRadius="md"
                        src={
                          'https://res.cloudinary.com/dujun1hoe/image/upload/v1615296945/event-s/icons/event_h6dtmv.png'
                        }
                        alt=""
                      />
                  ...
                  >
                    <Wrap align={'center'}>
                      <Image
                        borderRadius="md"
                        src={
                          'https://res.cloudinary.com/dujun1hoe/image/upload/v1615296945/event-s/icons/done_r4quc3.png'
                        }
                        alt=""
                      />
